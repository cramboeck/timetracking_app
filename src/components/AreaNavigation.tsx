...
export type SubView =
  ...
  // Business
  | 'dashboard' | 'leads' | 'pipeline' | 'billing' | 'reports' | 'contracts' | 'social-media' | 'invoices'
...
export const getAreaFromSubView = (subView: SubView): Area => {
  ...
  if (['dashboard', 'leads', 'pipeline', 'billing', 'reports', 'contracts', 'social-media', 'invoices'].includes(subView)) return 'business';
