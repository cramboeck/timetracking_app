...
**Offen (weitere Pässe, nach User-Validierung):** ManualEntryModern/Stopwatch-Felder, CustomerHub-Dialoge (Kunde/Projekt/Kontakt), Leads/InteractionForm, Settings-Formulare. Muster: Feld für Feld auf `Input/Select/Textarea` mit `label`-Prop, Grids auf `FormRow`.
