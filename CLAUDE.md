...
**Offen (Teil 2, nach Validierung):** Fälligkeits-Radar (Karte „fällig/überfällig" + Erinnerung; sauber erst mit sevDesk-Zahlstatus-Sync), Lieferanten-Gedächtnis (supplier→sevDesk-Kontakt beim Bestätigen merken + vorbelegen), Batch-Bestätigung.
